...
class MemorialGenerator(QDialog, FORM_CLASS):
    """Contain all routines for genereting memorial.
    """
    ...
    def createFullMemorialPdf(self):
        """Create a full memorial in pdf format (implemented by Guilherme)
        :param: self
        :return:
        """
        #print 1
    ...
    def createFullMemorialOdt(self):
        """Create a full memorial in odt format
        :param: self
        :return:
        """
    ...
    def insertDescriptionodt(self):
        """Insert a description in odt format
        :param: self
        :return:
        """
